...
export default function index() {
    ...
    return (
        <ul role="list" className="p-10 grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            {people.map((person) => (
                <li
                    key={person.email}
                ...
                >
                    <Link href={`/product/${person.slug}`} passHref>
                        <div className="flex-1 flex flex-col p-8 bg-red-500 cursor-pointer">
