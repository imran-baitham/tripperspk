      ...
      <div className="w-full h-auto w-5/6 m-auto rounded-md">
        <div className="flex-1 relative z-0 flex overflow-hidden my-10">
          <main className="flex-1 relative z-0 overflow-y-auto focus:outline-none mr-3">
            ...
            >
              <SwiperSlide>
                <img className="h-[500px] bg-gray-200 w-full" src={person.productApiUrl} alt="" />
              </SwiperSlide>
              <SwiperSlide>
                <img className="h-[500px] bg-gray-200 w-full" src={person.productApiUrl} alt="" />
              </SwiperSlide>
          ...
          <aside className="relative xl:flex xl:flex-col flex-shrink-0 w-96 overflow-y-auto">
            <div className="border border-1 p-5 h-full">
              ...
              >
                <div>
                  <img className="h-14 w-14 rounded-full mr-3" src={person.productApiUrl} alt="image" />
                </div>
                <div className="flex-1 min-w-0">
                  <a href="#" className="">
                    <span className="absolute inset-0" aria-hidden="true" />
                    <p className="text-sm font-medium text-gray-900">{person.name}</p>
                    <p className="text-sm text-gray-500 truncate">{person.member}</p>
                  </a>
                </div>
              </div>
          ...
          <main className="flex-1 relative z-0 overflow-y-auto focus:outline-none mr-3 border border-1 border-gray-300 p-5">
            ...
            <div className="my-10">
              <div className="relative flex items-center">
                <div>
                  <img className="h-12 w-12 rounded-full mr-3" src={person.productApiUrl} alt="image" />
                </div>
                <div className="flex-1 min-w-0">
                  <a href="#" className="">
                    <span className="absolute inset-0" aria-hidden="true" />
                    <p className="text-sm font-medium text-gray-900">{person.name}</p>
                    <p className="text-sm text-gray-500 truncate">{"helpful"}</p>
                  </a>
                </div>
              </div>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <a href="#" className="">
                    <span className="absolute inset-0" aria-hidden="true" />
                    <p className="text-sm font-medium text-gray-900">{person.name}</p>
                    <p className="text-sm text-gray-500 truncate">{"Nice work"}</p>
                  </a>
                </div>
              </div>
            </div>
            <input type={"text"} placeholder="Write your review" className={"mt-14 w-full border border-gray-300 p-4 outline-none"} />
          </main>
          <aside className="relative xl:flex xl:flex-col flex-shrink-0 w-96 overflow-y-auto">
